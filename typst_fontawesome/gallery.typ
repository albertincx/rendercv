...
#table(
  ...
  ```typst #fa-rectangle-hdr()```, fa-rectangle-hdr(), fa-rectangle-hdr(solid: true), fa-icon("rectangle-hdr"),
  ...
  ```typst #fa-numpad()```, fa-numpad(), fa-numpad(solid: true), fa-icon("numpad"),
  ...
  ```typst #fa-mailbox-open-empty()```, fa-mailbox-open-empty(), fa-mailbox-open-empty(solid: true), fa-icon("mailbox-open-empty"),
  ```typst #fa-mailbox-open-letter()```, fa-mailbox-open-letter(), fa-mailbox-open-letter(solid: true), fa-icon("mailbox-open-letter"),
  ```typst #fa-lychee()```, fa-lychee(), fa-lychee(solid: true), fa-icon("lychee"),
  ```typst #fa-tank-recovery()```, fa-tank-recovery(), fa-tank-recovery(solid: true), fa-icon("tank-recovery"),
  ```typst #fa-transducer()```, fa-transducer(), fa-transducer(solid: true), fa-icon("transducer"),
  ```typst #fa-box-arrow-up()```, fa-box-arrow-up(), fa-box-arrow-up(solid: true), fa-icon("box-arrow-up"),
  ```typst #fa-box-magnifying-glass()```, fa-box-magnifying-glass(), fa-box-magnifying-glass(solid: true), fa-icon("box-magnifying-glass"),
  ```typst #fa-envelope-certificate()```, fa-envelope-certificate(), fa-envelope-certificate(solid: true), fa-icon("envelope-certificate"),
  ```typst #fa-envelope-ribbon()```, fa-envelope-ribbon(), fa-envelope-ribbon(solid: true), fa-icon("envelope-ribbon"),
  ```typst #fa-water-temp()```, fa-water-temp(), fa-water-temp(solid: true), fa-icon("water-temp"),
  ```typst #fa-water-temperature()```, fa-water-temperature(), fa-water-temperature(solid: true), fa-icon("water-temperature"),
  ```typst #fa-aeropress()```, fa-aeropress(), fa-aeropress(solid: true), fa-icon("aeropress"),
  ```typst #fa-caret-large-down()```, fa-caret-large-down(), fa-caret-large-down(solid: true), fa-icon("caret-large-down"),
  ```typst #fa-caret-large-left()```, fa-caret-large-left(), fa-caret-large-left(solid: true), fa-icon("caret-large-left"),
  ```typst #fa-caret-large-right()```, fa-caret-large-right(), fa-caret-large-right(solid: true), fa-icon("caret-large-right"),
  ```typst #fa-caret-large-up()```, fa-caret-large-up(), fa-caret-large-up(solid: true), fa-icon("caret-large-up"),
  ```typst #fa-chemex()```, fa-chemex(), fa-chemex(solid: true), fa-icon("chemex"),
  ```typst #fa-hand-shaka()```, fa-hand-shaka(), fa-hand-shaka(solid: true), fa-icon("hand-shaka"),
  ```typst #fa-kettlebell()```, fa-kettlebell(), fa-kettlebell(solid: true), fa-icon("kettlebell"),
  ```typst #fa-supportnow()```, fa-supportnow(), fa-supportnow(solid: true), fa-icon("supportnow"),
  ```typst #fa-foot-wing()```, fa-foot-wing(), fa-foot-wing(solid: true), fa-icon("foot-wing"),
  ```typst #fa-pump-impeller()```, fa-pump-impeller(), fa-pump-impeller(solid: true), fa-icon("pump-impeller"),
  ```typst #fa-arrow-rotate-left-10()```, fa-arrow-rotate-left-10(), fa-arrow-rotate-left-10(solid: true), fa-icon("arrow-rotate-left-10"),
  ```typst #fa-arrow-rotate-right-10()```, fa-arrow-rotate-right-10(), fa-arrow-rotate-right-10(solid: true), fa-icon("arrow-rotate-right-10"),
  ```typst #fa-tor-browser()```, fa-tor-browser(), fa-tor-browser(solid: true), fa-icon("tor-browser"),
  ```typst #fa-arrow-archery()```, fa-arrow-archery(), fa-arrow-archery(solid: true), fa-icon("arrow-archery"),
  ```typst #fa-bow-archery()```, fa-bow-archery(), fa-bow-archery(solid: true), fa-icon("bow-archery"),
  ```typst #fa-eye-closed()```, fa-eye-closed(), fa-eye-closed(solid: true), fa-icon("eye-closed"),
  ```typst #fa-file-css()```, fa-file-css(), fa-file-css(solid: true), fa-icon("file-css"),
  ```typst #fa-file-html()```, fa-file-html(), fa-file-html(solid: true), fa-icon("file-html"),
  ```typst #fa-file-js()```, fa-file-js(), fa-file-js(solid: true), fa-icon("file-js"),
  ```typst #fa-layer()```, fa-layer(), fa-layer(solid: true), fa-icon("layer"),
  ```typst #fa-typescript()```, fa-typescript(), fa-typescript(solid: true), fa-icon("typescript"),
  ```typst #fa-file-icns()```, fa-file-icns(), fa-file-icns(solid: true), fa-icon("file-icns"),
  ```typst #fa-link-broken()```, fa-link-broken(), fa-link-broken(solid: true), fa-icon("link-broken"),
  ```typst #fa-gpu()```, fa-gpu(), fa-gpu(solid: true), fa-icon("gpu"),
  ```typst #fa-square-deskpro()```, fa-square-deskpro(), fa-square-deskpro(solid: true), fa-icon("square-deskpro"),
  ```typst #fa-aquarius()```, fa-aquarius(), fa-aquarius(solid: true), fa-icon("aquarius"),
  ```typst #fa-aries()```, fa-aries(), fa-aries(solid: true), fa-icon("aries"),
  ```typst #fa-cancer()```, fa-cancer(), fa-cancer(solid: true), fa-icon("cancer"),
  ```typst #fa-capricorn()```, fa-capricorn(), fa-capricorn(solid: true), fa-icon("capricorn"),
  ```typst #fa-gemini()```, fa-gemini(), fa-gemini(solid: true), fa-icon("gemini"),
  ```typst #fa-leo()```, fa-leo(), fa-leo(solid: true), fa-icon("leo"),
  ```typst #fa-libra()```, fa-libra(), fa-libra(solid: true), fa-icon("libra"),
  ```typst #fa-pisces()```, fa-pisces(), fa-pisces(solid: true), fa-icon("pisces"),
  ```typst #fa-sagittarius()```, fa-sagittarius(), fa-sagittarius(solid: true), fa-icon("sagittarius"),
  ```typst #fa-scorpio()```, fa-scorpio(), fa-scorpio(solid: true), fa-icon("scorpio"),
  ```typst #fa-taurus()```, fa-taurus(), fa-taurus(solid: true), fa-icon("taurus"),
  ```typst #fa-virgo()```, fa-virgo(), fa-virgo(solid: true), fa-icon("virgo"),
  ```typst #fa-circle-zulip()```, fa-circle-zulip(), fa-circle-zulip(solid: true), fa-icon("circle-zulip"),
  ```typst #fa-julia()```, fa-julia(), fa-julia(solid: true), fa-icon("julia"),
  ```typst #fa-zulip()```, fa-zulip(), fa-zulip(solid: true), fa-icon("zulip"),
  ```typst #fa-unison()```, fa-unison(), fa-unison(solid: true), fa-icon("unison"),
  ```typst #fa-bgg()```, fa-bgg(), fa-bgg(solid: true), fa-icon("bgg"),
  ```typst #fa-board-game-geek()```, fa-board-game-geek(), fa-board-game-geek(solid: true), fa-icon("board-game-geek"),
  ```typst #fa-ko-fi()```, fa-ko-fi(), fa-ko-fi(solid: true), fa-icon("ko-fi"),
  ```typst #fa-kubernetes()```, fa-kubernetes(), fa-kubernetes(solid: true), fa-icon("kubernetes"),
  ```typst #fa-postgresql()```, fa-postgresql(), fa-postgresql(solid: true), fa-icon("postgresql"),
  ```typst #fa-scaleway()```, fa-scaleway(), fa-scaleway(solid: true), fa-icon("scaleway"),
  ```typst #fa-venmo()```, fa-venmo(), fa-venmo(solid: true), fa-icon("venmo"),
  ```typst #fa-venmo-v()```, fa-venmo-v(), fa-venmo-v(solid: true), fa-icon("venmo-v"),
  ```typst #fa-unreal-engine()```, fa-unreal-engine(), fa-unreal-engine(solid: true), fa-icon("unreal-engine"),
  ```typst #fa-globaleaks()```, fa-globaleaks(), fa-globaleaks(solid: true), fa-icon("globaleaks"),
  ```typst #fa-solana()```, fa-solana(), fa-solana(solid: true), fa-icon("solana"),
  ```typst #fa-threema()```, fa-threema(), fa-threema(solid: true), fa-icon("threema"),
  ```typst #fa-forgejo()```, fa-forgejo(), fa-forgejo(solid: true), fa-icon("forgejo"),
  ```typst #fa-claude()```, fa-claude(), fa-claude(solid: true), fa-icon("claude"),
  ```typst #fa-bicep()```, fa-bicep(), fa-bicep(solid: true), fa-icon("bicep"),
  ```typst #fa-gitee()```, fa-gitee(), fa-gitee(solid: true), fa-icon("gitee"),
  ```typst #fa-xmpp()```, fa-xmpp(), fa-xmpp(solid: true), fa-icon("xmpp"),
  ```typst #fa-fediverse()```, fa-fediverse(), fa-fediverse(solid: true), fa-icon("fediverse"),
  ```typst #fa-tailwind-css()```, fa-tailwind-css(), fa-tailwind-css(solid: true), fa-icon("tailwind-css"),
  ```typst #fa-arch-linux()```, fa-arch-linux(), fa-arch-linux(solid: true), fa-icon("arch-linux"),
  ```typst #fa-svelte()```, fa-svelte(), fa-svelte(solid: true), fa-icon("svelte"),
  ```typst #fa-hugging-face()```, fa-hugging-face(), fa-hugging-face(solid: true), fa-icon("hugging-face"),
  ```typst #fa-leetcode()```, fa-leetcode(), fa-leetcode(solid: true), fa-icon("leetcode"),
  ```typst #fa-openstreetmap()```, fa-openstreetmap(), fa-openstreetmap(solid: true), fa-icon("openstreetmap"),
  ```typst #fa-rectangle-irc()```, fa-rectangle-irc(), fa-rectangle-irc(solid: true), fa-icon("rectangle-irc"),
  ```typst #fa-ultralytics()```, fa-ultralytics(), fa-ultralytics(solid: true), fa-icon("ultralytics"),
  ```typst #fa-ultralytics-hub()```, fa-ultralytics-hub(), fa-ultralytics-hub(solid: true), fa-icon("ultralytics-hub"),
  ```typst #fa-ultralytics-yolo()```, fa-ultralytics-yolo(), fa-ultralytics-yolo(solid: true), fa-icon("ultralytics-yolo"),
  ```typst #fa-moon-first-quarter()```, fa-moon-first-quarter(), fa-moon-first-quarter(solid: true), fa-icon("moon-first-quarter"),
  ```typst #fa-moon-last-quarter-inverse()```, fa-moon-last-quarter-inverse(), fa-moon-last-quarter-inverse(solid: true), fa-icon("moon-last-quarter-inverse"),
  ```typst #fa-moon-full()```, fa-moon-full(), fa-moon-full(solid: true), fa-icon("moon-full"),
  ```typst #fa-moon-new-inverse()```, fa-moon-new-inverse(), fa-moon-new-inverse(solid: true), fa-icon("moon-new-inverse"),
  ```typst #fa-moon-first-quarter-inverse()```, fa-moon-first-quarter-inverse(), fa-moon-first-quarter-inverse(solid: true), fa-icon("moon-first-quarter-inverse"),
  ```typst #fa-moon-last-quarter()```, fa-moon-last-quarter(), fa-moon-last-quarter(solid: true), fa-icon("moon-last-quarter"),
  ```typst #fa-moon-full-inverse()```, fa-moon-full-inverse(), fa-moon-full-inverse(solid: true), fa-icon("moon-full-inverse"),
  ```typst #fa-moon-new()```, fa-moon-new(), fa-moon-new(solid: true), fa-icon("moon-new"),
  ```typst #fa-moon-waning-crescent()```, fa-moon-waning-crescent(), fa-moon-waning-crescent(solid: true), fa-icon("moon-waning-crescent"),
  ```typst #fa-moon-waxing-gibbous-inverse()```, fa-moon-waxing-gibbous-inverse(), fa-moon-waxing-gibbous-inverse(solid: true), fa-icon("moon-waxing-gibbous-inverse"),
  ```typst #fa-moon-waning-gibbous()```, fa-moon-waning-gibbous(), fa-moon-waning-gibbous(solid: true), fa-icon("moon-waning-gibbous"),
  ```typst #fa-moon-waxing-crescent-inverse()```, fa-moon-waxing-crescent-inverse(), fa-moon-waxing-crescent-inverse(solid: true), fa-icon("moon-waxing-crescent-inverse"),
  ```typst #fa-moon-waning-gibbous-inverse()```, fa-moon-waning-gibbous-inverse(), fa-moon-waning-gibbous-inverse(solid: true), fa-icon("moon-waning-gibbous-inverse"),
  ```typst #fa-moon-waxing-crescent()```, fa-moon-waxing-crescent(), fa-moon-waxing-crescent(solid: true), fa-icon("moon-waxing-crescent"),
  ```typst #fa-moon-waning-crescent-inverse()```, fa-moon-waning-crescent-inverse(), fa-moon-waning-crescent-inverse(solid: true), fa-icon("moon-waning-crescent-inverse"),
  ```typst #fa-moon-waxing-gibbous()```, fa-moon-waxing-gibbous(), fa-moon-waxing-gibbous(solid: true), fa-icon("moon-waxing-gibbous"),
  ```typst #fa-burst-new()```, fa-burst-new(), fa-burst-new(solid: true), fa-icon("burst-new"),
  ```typst #fa-obsidian()```, fa-obsidian(), fa-obsidian(solid: true), fa-icon("obsidian"),
  ```typst #fa-rectangle-new()```, fa-rectangle-new(), fa-rectangle-new(solid: true), fa-icon("rectangle-new"),
  ```typst #fa-zoom()```, fa-zoom(), fa-zoom(solid: true), fa-icon("zoom"),
  ```typst #fa-opossum()```, fa-opossum(), fa-opossum(solid: true), fa-icon("opossum"),
  ```typst #fa-possum()```, fa-possum(), fa-possum(solid: true), fa-icon("possum"),
  ```typst #fa-input-password()```, fa-input-password(), fa-input-password(solid: true), fa-icon("input-password"),
  ```typst #fa-desk()```, fa-desk(), fa-desk(solid: true), fa-icon("desk"),
  ```typst #fa-dresser()```, fa-dresser(), fa-dresser(solid: true), fa-icon("dresser"),
  ```typst #fa-stool()```, fa-stool(), fa-stool(solid: true), fa-icon("stool"),
  ```typst #fa-wardrobe()```, fa-wardrobe(), fa-wardrobe(solid: true), fa-icon("wardrobe"),
  ```typst #fa-table-dining()```, fa-table-dining(), fa-table-dining(solid: true), fa-icon("table-dining"),
  ```typst #fa-chest-drawers()```, fa-chest-drawers(), fa-chest-drawers(solid: true), fa-icon("chest-drawers"),
  ```typst #fa-oar()```, fa-oar(), fa-oar(solid: true), fa-icon("oar"),
  ```typst #fa-oars()```, fa-oars(), fa-oars(solid: true), fa-icon("oars"),
  ```typst #fa-arrow-rotate-left-15()```, fa-arrow-rotate-left-15(), fa-arrow-rotate-left-15(solid: true), fa-icon("arrow-rotate-left-15"),
  ```typst #fa-arrow-rotate-left-30()```, fa-arrow-rotate-left-30(), fa-arrow-rotate-left-30(solid: true), fa-icon("arrow-rotate-left-30"),
  ```typst #fa-arrow-rotate-right-15()```, fa-arrow-rotate-right-15(), fa-arrow-rotate-right-15(solid: true), fa-icon("arrow-rotate-right-15"),
  ```typst #fa-arrow-rotate-right-30()```, fa-arrow-rotate-right-30(), fa-arrow-rotate-right-30(solid: true), fa-icon("arrow-rotate-right-30"),
  ```typst #fa-vim()```, fa-vim(), fa-vim(solid: true), fa-icon("vim"),
  ```typst #fa-rows-3()```, fa-rows-3(), fa-rows-3(solid: true), fa-icon("rows-3"),
  ```typst #fa-table-cells-merge()```, fa-table-cells-merge(), fa-table-cells-merge(solid: true), fa-icon("table-cells-merge"),
  ```typst #fa-table-cells-split()```, fa-table-cells-split(), fa-table-cells-split(solid: true), fa-icon("table-cells-split"),
  ```typst #fa-table-columns-add-after()```, fa-table-columns-add-after(), fa-table-columns-add-after(solid: true), fa-icon("table-columns-add-after"),
  ```typst #fa-table-columns-add-before()```, fa-table-columns-add-before(), fa-table-columns-add-before(solid: true), fa-icon("table-columns-add-before"),
  ```typst #fa-table-columns-merge-next()```, fa-table-columns-merge-next(), fa-table-columns-merge-next(solid: true), fa-icon("table-columns-merge-next"),
  ```typst #fa-table-columns-merge-previous()```, fa-table-columns-merge-previous(), fa-table-columns-merge-previous(solid: true), fa-icon("table-columns-merge-previous"),
  ```typst #fa-table-columns-remove-after()```, fa-table-columns-remove-after(), fa-table-columns-remove-after(solid: true), fa-icon("table-columns-remove-after"),
  ```typst #fa-table-columns-remove-before()```, fa-table-columns-remove-before(), fa-table-columns-remove-before(solid: true), fa-icon("table-columns-remove-before"),
  ```typst #fa-table-rows-add-above()```, fa-table-rows-add-above(), fa-table-rows-add-above(solid: true), fa-icon("table-rows-add-above"),
  ```typst #fa-table-rows-add-below()```, fa-table-rows-add-below(), fa-table-rows-add-below(solid: true), fa-icon("table-rows-add-below"),
  ```typst #fa-table-rows-merge-next()```, fa-table-rows-merge-next(), fa-table-rows-merge-next(solid: true), fa-icon("table-rows-merge-next"),
  ```typst #fa-table-rows-merge-previous()```, fa-table-rows-merge-previous(), fa-table-rows-merge-previous(solid: true), fa-icon("table-rows-merge-previous"),
  ```typst #fa-table-rows-remove-above()```, fa-table-rows-remove-above(), fa-table-rows-remove-above(solid: true), fa-icon("table-rows-remove-above"),
  ```typst #fa-table-rows-remove-below()```, fa-table-rows-remove-below(), fa-table-rows-remove-below(solid: true), fa-icon("table-rows-remove-below"),
  ```typst #fa-table-slash()```, fa-table-slash(), fa-table-slash(solid: true), fa-icon("table-slash"),
  ```typst #fa-kayak()```, fa-kayak(), fa-kayak(solid: true), fa-icon("kayak"),
  ```typst #fa-canoe-person()```, fa-canoe-person(), fa-canoe-person(solid: true), fa-icon("canoe-person"),
  ```typst #fa-utility-can()```, fa-utility-can(), fa-utility-can(solid: true), fa-icon("utility-can"),
  ```typst #fa-table-bar()```, fa-table-bar(), fa-table-bar(solid: true), fa-icon("table-bar"),
  ```typst #fa-owl()```, fa-owl(), fa-owl(solid: true), fa-icon("owl"),
  ```typst #fa-rectangle-api()```, fa-rectangle-api(), fa-rectangle-api(solid: true), fa-icon("rectangle-api"),
  ```typst #fa-nas()```, fa-nas(), fa-nas(solid: true), fa-icon("nas"),
  ```typst #fa-poker-chip()```, fa-poker-chip(), fa-poker-chip(solid: true), fa-icon("poker-chip"),
  ```typst #fa-tower-receive()```, fa-tower-receive(), fa-tower-receive(solid: true), fa-icon("tower-receive"),
  ```typst #fa-gear-api()```, fa-gear-api(), fa-gear-api(solid: true), fa-icon("gear-api"),
  ```typst #fa-gear-complex-api()```, fa-gear-complex-api(), fa-gear-complex-api(solid: true), fa-icon("gear-complex-api"),
  ```typst #fa-globe-www()```, fa-globe-www(), fa-globe-www(solid: true), fa-icon("globe-www"),
  ```typst #fa-label()```, fa-label(), fa-label(solid: true), fa-icon("label"),
  ```typst #fa-rectangle-n-a()```, fa-rectangle-n-a(), fa-rectangle-n-a(solid: true), fa-icon("rectangle-n-a"),
  ```typst #fa-remote()```, fa-remote(), fa-remote(solid: true), fa-icon("remote"),
  ```typst #fa-image-broken()```, fa-image-broken(), fa-image-broken(solid: true), fa-icon("image-broken"),
  ```typst #fa-symfonycasts()```, fa-symfonycasts(), fa-symfonycasts(solid: true), fa-icon("symfonycasts"),
  ```typst #fa-build-awesome()```, fa-build-awesome(), fa-build-awesome(solid: true), fa-icon("build-awesome"),
  ```typst #fa-codeberg()```, fa-codeberg(), fa-codeberg(solid: true), fa-icon("codeberg"),
  ```typst #fa-devpost()```, fa-devpost(), fa-devpost(solid: true), fa-icon("devpost"),
  ```typst #fa-envelope-heart()```, fa-envelope-heart(), fa-envelope-heart(solid: true), fa-icon("envelope-heart"),
  ```typst #fa-internet-archive()```, fa-internet-archive(), fa-internet-archive(solid: true), fa-icon("internet-archive"),
  ```typst #fa-lets-encrypt()```, fa-lets-encrypt(), fa-lets-encrypt(solid: true), fa-icon("lets-encrypt"),
  ```typst #fa-matrix()```, fa-matrix(), fa-matrix(solid: true), fa-icon("matrix"),
  ```typst #fa-mattermost()```, fa-mattermost(), fa-mattermost(solid: true), fa-icon("mattermost"),
  ```typst #fa-nextcloud()```, fa-nextcloud(), fa-nextcloud(solid: true), fa-icon("nextcloud"),
  ```typst #fa-roblox-creator-studio()```, fa-roblox-creator-studio(), fa-roblox-creator-studio(solid: true), fa-icon("roblox-creator-studio"),
  ```typst #fa-square-build-awesome-stroke()```, fa-square-build-awesome-stroke(), fa-square-build-awesome-stroke(solid: true), fa-icon("square-build-awesome-stroke"),
  ```typst #fa-substack()```, fa-substack(), fa-substack(solid: true), fa-icon("substack"),
  ```typst #fa-tesla()```, fa-tesla(), fa-tesla(solid: true), fa-icon("tesla"),
  ```typst #fa-xrp()```, fa-xrp(), fa-xrp(solid: true), fa-icon("xrp"),
  ```typst #fa-xrpl()```, fa-xrpl(), fa-xrpl(solid: true), fa-icon("xrpl"),
  ```typst #fa-youtube-shorts()```, fa-youtube-shorts(), fa-youtube-shorts(solid: true), fa-icon("youtube-shorts"),
  ```typst #fa-ror()```, fa-ror(), fa-ror(solid: true), fa-icon("ror"),
  ```typst #fa-visual-studio()```, fa-visual-studio(), fa-visual-studio(solid: true), fa-icon("visual-studio"),
  ```typst #fa-dolibarr()```, fa-dolibarr(), fa-dolibarr(solid: true), fa-icon("dolibarr"),
  ```typst #fa-obs-studio()```, fa-obs-studio(), fa-obs-studio(solid: true), fa-icon("obs-studio"),
  ```typst #fa-storybook()```, fa-storybook(), fa-storybook(solid: true), fa-icon("storybook"),
  ```typst #fa-a11y-project()```, fa-a11y-project(), fa-a11y-project(solid: true), fa-icon("a11y-project"),
  ```typst #fa-Suricata()```, fa-Suricata(), fa-Suricata(solid: true), fa-icon("Suricata"),
  ```typst #fa-meerkat()```, fa-meerkat(), fa-meerkat(solid: true), fa-icon("meerkat"),
  ```typst #fa-suricate()```, fa-suricate(), fa-suricate(solid: true), fa-icon("suricate"),
  ```typst #fa-suricatta()```, fa-suricatta(), fa-suricatta(solid: true), fa-icon("suricatta"),
  ```typst #fa-file-md()```, fa-file-md(), fa-file-md(solid: true), fa-icon("file-md"),
  ```typst #fa-file-txt()```, fa-file-txt(), fa-file-txt(solid: true), fa-icon("file-txt"),
  ```typst #fa-copilot()```, fa-copilot(), fa-copilot(solid: true), fa-icon("copilot"),
  ...
  ```typst #fa-lotus()```, fa-lotus(), fa-lotus(solid: true), fa-icon("lotus"),
  ...
  ```typst #fa-handshake-alt-slash-6()```, fa-handshake-alt-slash-6(), fa-handshake-alt-slash-6(solid: true), fa-icon("handshake-alt-slash-6"),
  ```typst #fa-handshake-simple-slash-6()```, fa-handshake-simple-slash-6(), fa-handshake-simple-slash-6(solid: true), fa-icon("handshake-simple-slash-6"),
  ```typst #fa-toilet-paper-blank-under-6()```, fa-toilet-paper-blank-under-6(), fa-toilet-paper-blank-under-6(solid: true), fa-icon("toilet-paper-blank-under-6"),
  ```typst #fa-toilet-paper-reverse-alt-6()```, fa-toilet-paper-reverse-alt-6(), fa-toilet-paper-reverse-alt-6(solid: true), fa-icon("toilet-paper-reverse-alt-6"),
  ```typst #fa-vector-circle-6()```, fa-vector-circle-6(), fa-vector-circle-6(solid: true), fa-icon("vector-circle-6"),
  ```typst #fa-vector-polygon-6()```, fa-vector-polygon-6(), fa-vector-polygon-6(solid: true), fa-icon("vector-polygon-6"),
  ```typst #fa-grid-horizontal-6()```, fa-grid-horizontal-6(), fa-grid-horizontal-6(solid: true), fa-icon("grid-horizontal-6"),
  ```typst #fa-hexagon-vertical-nft-slanted-6()```, fa-hexagon-vertical-nft-slanted-6(), fa-hexagon-vertical-nft-slanted-6(solid: true), fa-icon("hexagon-vertical-nft-slanted-6"),
  ```typst #fa-film-alt-6()```, fa-film-alt-6(), fa-film-alt-6(solid: true), fa-icon("film-alt-6"),
  ```typst #fa-film-simple-6()```, fa-film-simple-6(), fa-film-simple-6(solid: true), fa-icon("film-simple-6"),
  ```typst #fa-user-alt-6()```, fa-user-alt-6(), fa-user-alt-6(solid: true), fa-icon("user-alt-6"),
  ```typst #fa-user-large-6()```, fa-user-large-6(), fa-user-large-6(solid: true), fa-icon("user-large-6"),
  ```typst #fa-handshake-alt-6()```, fa-handshake-alt-6(), fa-handshake-alt-6(solid: true), fa-icon("handshake-alt-6"),
  ```typst #fa-handshake-simple-6()```, fa-handshake-simple-6(), fa-handshake-simple-6(solid: true), fa-icon("handshake-simple-6"),
  ```typst #fa-user-alt-slash-6()```, fa-user-alt-slash-6(), fa-user-alt-slash-6(solid: true), fa-icon("user-alt-slash-6"),
  ```typst #fa-user-large-slash-6()```, fa-user-large-slash-6(), fa-user-large-slash-6(solid: true), fa-icon("user-large-slash-6"),
  ```typst #fa-headphones-alt-6()```, fa-headphones-alt-6(), fa-headphones-alt-6(solid: true), fa-icon("headphones-alt-6"),
  ```typst #fa-headphones-simple-6()```, fa-headphones-simple-6(), fa-headphones-simple-6(solid: true), fa-icon("headphones-simple-6"),
  ```typst #fa-vector-square-6()```, fa-vector-square-6(), fa-vector-square-6(solid: true), fa-icon("vector-square-6"),
  ```typst #fa-toilet-paper-alt-6()```, fa-toilet-paper-alt-6(), fa-toilet-paper-alt-6(solid: true), fa-icon("toilet-paper-alt-6"),
  ```typst #fa-toilet-paper-blank-6()```, fa-toilet-paper-blank-6(), fa-toilet-paper-blank-6(solid: true), fa-icon("toilet-paper-blank-6"),
  ```typst #fa-handshake-alt-slash-7()```, fa-handshake-alt-slash-7(), fa-handshake-alt-slash-7(solid: true), fa-icon("handshake-alt-slash-7"),
  ```typst #fa-handshake-simple-slash-7()```, fa-handshake-simple-slash-7(), fa-handshake-simple-slash-7(solid: true), fa-icon("handshake-simple-slash-7"),
  ```typst #fa-toilet-paper-blank-under-7()```, fa-toilet-paper-blank-under-7(), fa-toilet-paper-blank-under-7(solid: true), fa-icon("toilet-paper-blank-under-7"),
  ```typst #fa-toilet-paper-reverse-alt-7()```, fa-toilet-paper-reverse-alt-7(), fa-toilet-paper-reverse-alt-7(solid: true), fa-icon("toilet-paper-reverse-alt-7"),
  ```typst #fa-hexagon-vertical-nft-slanted-7()```, fa-hexagon-vertical-nft-slanted-7(), fa-hexagon-vertical-nft-slanted-7(solid: true), fa-icon("hexagon-vertical-nft-slanted-7"),
  ```typst #fa-user-alt-7()```, fa-user-alt-7(), fa-user-alt-7(solid: true), fa-icon("user-alt-7"),
  ```typst #fa-user-large-7()```, fa-user-large-7(), fa-user-large-7(solid: true), fa-icon("user-large-7"),
  ```typst #fa-film-alt-7()```, fa-film-alt-7(), fa-film-alt-7(solid: true), fa-icon("film-alt-7"),
  ```typst #fa-film-simple-7()```, fa-film-simple-7(), fa-film-simple-7(solid: true), fa-icon("film-simple-7"),
  ```typst #fa-headphones-alt-7()```, fa-headphones-alt-7(), fa-headphones-alt-7(solid: true), fa-icon("headphones-alt-7"),
  ```typst #fa-headphones-simple-7()```, fa-headphones-simple-7(), fa-headphones-simple-7(solid: true), fa-icon("headphones-simple-7"),
  ```typst #fa-handshake-alt-7()```, fa-handshake-alt-7(), fa-handshake-alt-7(solid: true), fa-icon("handshake-alt-7"),
  ```typst #fa-handshake-simple-7()```, fa-handshake-simple-7(), fa-handshake-simple-7(solid: true), fa-icon("handshake-simple-7"),
  ```typst #fa-user-alt-slash-7()```, fa-user-alt-slash-7(), fa-user-alt-slash-7(solid: true), fa-icon("user-alt-slash-7"),
  ```typst #fa-user-large-slash-7()```, fa-user-large-slash-7(), fa-user-large-slash-7(solid: true), fa-icon("user-large-slash-7"),
  ```typst #fa-grid-horizontal-7()```, fa-grid-horizontal-7(), fa-grid-horizontal-7(solid: true), fa-icon("grid-horizontal-7"),
  ```typst #fa-vector-circle-7()```, fa-vector-circle-7(), fa-vector-circle-7(solid: true), fa-icon("vector-circle-7"),
  ```typst #fa-vector-polygon-7()```, fa-vector-polygon-7(), fa-vector-polygon-7(solid: true), fa-icon("vector-polygon-7"),
  ```typst #fa-vector-square-7()```, fa-vector-square-7(), fa-vector-square-7(solid: true), fa-icon("vector-square-7"),
  ```typst #fa-toilet-paper-alt-7()```, fa-toilet-paper-alt-7(), fa-toilet-paper-alt-7(solid: true), fa-icon("toilet-paper-alt-7"),
  ```typst #fa-toilet-paper-blank-7()```, fa-toilet-paper-blank-7(), fa-toilet-paper-blank-7(solid: true), fa-icon("toilet-paper-blank-7"),
)